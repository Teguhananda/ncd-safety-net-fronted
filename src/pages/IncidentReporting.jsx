...
const CATEGORIES = [
  ...
  ["followup_failure", "Follow-up Failure"],
  ["identification_issue", "Patient Identification Issue"],
...
export default function IncidentReporting() {
  ...
  const submit = async () => {
    ...
    setError("");
    try {
      await callApi("incident", { category, patientId: patientId || null, description });
      setDone(true);
      setDescription("");
      setPatientId("");
    } catch (e) {
